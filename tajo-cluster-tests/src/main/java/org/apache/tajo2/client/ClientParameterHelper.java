...
import static org.apache.tajo2.client.ClientParameterHelper.ActionType.CONNECTION_PARAM;
import static org.apache.tajo2.client.ClientParameterHelper.ActionType.SESSION_UPDATE;
...
class ClientParameterHelper {
  ...
  static {
    PARAMETERS.put(org.apache.tajo2.client.ClientParameters.USE_COMPRESSION, new SimpleSessionAction(COMPRESSED_RESULT_TRANSFER));
    PARAMETERS.put(org.apache.tajo2.client.ClientParameters.ROW_FETCH_SIZE, new SimpleSessionAction(FETCH_ROWNUM));
    PARAMETERS.put(org.apache.tajo2.client.ClientParameters.CONNECT_TIMEOUT, new ConnectionParamAction() {
      @Override
    ...
    PARAMETERS.put(org.apache.tajo2.client.ClientParameters.SOCKET_TIMEOUT, new ConnectionParamAction() {
      @Override
      Pair<String, String> doAction(String param) {
        int seconds = Integer.parseInt(param);
    ...
    PARAMETERS.put(org.apache.tajo2.client.ClientParameters.RETRY, new SimpleConnectionParamAction(RpcConstants.CLIENT_RETRY_NUM));
