...
public class QueryClientImpl implements QueryClient {
  ...
  private final org.apache.tajo2.client.SessionConnection conn;
  ...
  public ResultSet getQueryResultAndWait(QueryId queryId)
    ...
    org.apache.tajo2.client.QueryStatus status = TajoClientUtil.waitCompletion(this, queryId);
  ...
  @Override
  public org.apache.tajo2.client.QueryStatus getQueryStatus(QueryId queryId) throws QueryNotFoundException {
    ...
    return new org.apache.tajo2.client.QueryStatus(res);
  }
  ...
  @Override
  public Future<org.apache.tajo2.jdbc.TajoMemoryResultSet> fetchNextQueryResultAsync(final QueryId queryId, final int fetchRowNum) {

    final SettableFuture<org.apache.tajo2.jdbc.TajoMemoryResultSet> future = SettableFuture.create();
  ...
  protected org.apache.tajo2.jdbc.TajoMemoryResultSet fetchNextQueryResult(final QueryId queryId, final int fetchRowNum)
  ...
  @Override
  public org.apache.tajo2.client.QueryStatus killQuery(final QueryId queryId) throws QueryNotFoundException {
