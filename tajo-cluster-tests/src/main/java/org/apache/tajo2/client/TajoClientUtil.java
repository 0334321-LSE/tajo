...
public class TajoClientUtil {
  ...
  public static org.apache.tajo2.client.QueryStatus waitCompletion(org.apache.tajo2.client.QueryClient client, QueryId queryId) throws QueryNotFoundException {
  ...
  public static ResultSet createResultSet(TajoClient client, QueryId queryId,
    ...
    return new org.apache.tajo2.jdbc.FetchResultSet(client, desc.getLogicalSchema(), queryId, fetchRows);
  }
  ...
  public static ResultSet createResultSet(QueryClient client, ClientProtos.SubmitQueryResponse response, int fetchRows) {
    if (response.hasTableDesc()) {
      ...
      return new org.apache.tajo2.jdbc.TajoMemoryResultSet(new QueryId(response.getQueryId()),
  ...
  public static final ResultSet NULL_RESULT_SET =
      new org.apache.tajo2.jdbc.TajoMemoryResultSet(QueryIdFactory.NULL_QUERY_ID, SchemaBuilder.empty(), null, null);

  public static org.apache.tajo2.jdbc.TajoMemoryResultSet createNullResultSet(QueryId queryId) {
