...
public class TajoClient implements Closeable {
   ...
   */
  public TajoClient(String host) throws org.apache.tajo2.client.v2.exception.ClientUnableToConnectException {
    delegate = org.apache.tajo2.client.v2.ClientDelegateFactory.newDefaultDelegate(host, DEFAULT_PORT, null);
  }
   ...
   */
  public TajoClient(String host, Properties clientParams) throws org.apache.tajo2.client.v2.exception.ClientUnableToConnectException {
    delegate = org.apache.tajo2.client.v2.ClientDelegateFactory.newDefaultDelegate(host, DEFAULT_PORT, clientParams);
  }
   ...
   */
  public TajoClient(String host, int port) throws org.apache.tajo2.client.v2.exception.ClientUnableToConnectException {
    delegate = org.apache.tajo2.client.v2.ClientDelegateFactory.newDefaultDelegate(host, port, null);
  }
   ...
   * @param clientParams   Client connection parameters
   */
  public TajoClient(String host, int port, Properties clientParams) throws org.apache.tajo2.client.v2.exception.ClientUnableToConnectException {
    delegate = org.apache.tajo2.client.v2.ClientDelegateFactory.newDefaultDelegate(host, port, clientParams);
  }
   ...
   */
  public TajoClient(ServiceDiscovery discovery) throws org.apache.tajo2.client.v2.exception.ClientUnableToConnectException {
    delegate = org.apache.tajo2.client.v2.ClientDelegateFactory.newDefaultDelegate(discovery, null);
  }
