...
public class FetchResultSet extends TajoResultSetBase {
  ...
  private org.apache.tajo2.jdbc.TajoMemoryResultSet currentResultSet;
    ...
    if (nextResultSet != null) {
      try {
        ...
        if (t instanceof DefaultTajoException) {
          ...
          throw new org.apache.tajo2.jdbc.TajoSQLException(Errors.ResultCode.INTERNAL_ERROR, t, t.getMessage());
        }
      } catch (Throwable t) {
