...
public abstract class TajoResultSetBase implements ResultSet {
  ...
  private Date getDate(Tuple tuple, int index) throws SQLException {
    ...
    default:
      throw new org.apache.tajo2.jdbc.TajoSQLException(Errors.ResultCode.INVALID_VALUE_FOR_CAST, tuple.type(index).name(), "date");
    }
  }
  ...
  private Time getTime(Tuple tuple, int index) throws SQLException {
    ...
    default:
      throw new org.apache.tajo2.jdbc.TajoSQLException(Errors.ResultCode.INVALID_VALUE_FOR_CAST, tuple.type(index).name(), "time");
    }
  }
  ...
  private Timestamp getTimestamp(Tuple tuple, int index) throws SQLException {
    ...
    case TEXT:
      ...
      return toTimestamp(tm, timezone);
    default:
      throw new org.apache.tajo2.jdbc.TajoSQLException(Errors.ResultCode.INVALID_VALUE_FOR_CAST, tuple.type(index).name(), "timestamp");
    }
  }
