 ...
 * </ul>
 *
 * Especially, {@link #executeQuery() and {@link #assertResultSet(ResultSet)} methods automatically finds
...
public class QueryTestCaseBase {
  ...
  protected static org.apache.tajo2.client.TajoClient client;
  ...
  protected Optional<org.apache.tajo2.jdbc.TajoResultSetBase[]> runSimpleTests() throws Exception {
    ...
    try {
      ...
      List<org.apache.tajo2.jdbc.TajoResultSetBase> resultSetBases = new ArrayList<>();
      for (int i = 0; i < queries.length; i++) {
        ...
        resultSetBases.add((org.apache.tajo2.jdbc.TajoResultSetBase) result);
  ...
  public static QueryId getQueryId(ResultSet resultSet) {
    if (resultSet instanceof org.apache.tajo2.jdbc.TajoMemoryResultSet) {
      return ((TajoMemoryResultSet) resultSet).getQueryId();
    } else if (resultSet instanceof org.apache.tajo2.jdbc.FetchResultSet) {
