...
public class TajoTestingCluster {
  ...
  public org.apache.tajo2.client.TajoClient newTajoClient() throws Exception {
    return new org.apache.tajo2.client.TajoClientImpl(ServiceTrackerFactory.get(getConfiguration()));
  }
  ...
  public static ResultSet run(String[] names,
                              ...
                              String[][] tables,
                              String query,
                              org.apache.tajo2.client.TajoClient client) throws Exception {
  ...
  public static ResultSet run(String[] names,
    ...
    try (org.apache.tajo2.client.TajoClient client = new org.apache.tajo2.client.TajoClientImpl(ServiceTrackerFactory.get(conf))) {
      return run(names, schemas, tables, query, client);
    }
  }

  public static org.apache.tajo2.client.TajoClient newTajoClient(TajoTestingCluster util) throws SQLException, InterruptedException {
    while(true) {
      if(util.getMaster().isMasterRunning()) {
        break;
      }
